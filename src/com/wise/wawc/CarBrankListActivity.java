 ...
 * @author 王庆文
 */
public class CarBrankListActivity extends Activity implements
        IXListViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vehicleBrankList.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                String beank = ((BrankModel) adapter.getItem(arg2 - 1))
                        .getVehicleBrank();
    ...
    private void initViews() {
        ...
        progressDialog = ProgressDialog.show(CarBrankListActivity.this,
    ...
    public void onRefresh() {
        new Thread(new NetThread.GetDataThread(myHandler, Constant.BaseUrl
        ...
        public void handleMessage(Message msg) {
            ...
            case GET_BRANK:
                ...
                if (!"".equals(brankData)) {
                    ...
                    dBExcute.InsertDB(CarBrankListActivity.this, contentValues,
                            Constant.TB_Base);
            ...
            case REFRESH_BRANK:
                ...
                if (!"".equals(refreshData)) {
                    ...
                    // 更新数据库 TODO
                    // dBExcute.InsertDB(CarBrankListActivity.this,
                    // contentValues, Config.TB_Base);
                    JSONArray jsonArray = null;
                    try {
    ...
    private void getDate() {
        ...
        Cursor cursor = db.rawQuery("select * from " + Constant.TB_Base
                + " where Title = ?", new String[] { "carBrank" });
        JSONArray jsonArray = null;
        if (cursor.moveToFirst()) {
            progressDialog.dismiss();
            try {
                jsonArray = new JSONArray(cursor.getString(cursor
            ...
            new Thread(new NetThread.GetDataThread(myHandler, Constant.BaseUrl
                    + "base/car_brand", GET_BRANK)).start();
        }
        cursor.close();
        db.close();
    }
